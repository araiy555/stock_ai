...
<script async>
if (navigator.userAgent.indexOf('iPhone') > 0 || navigator.userAgent.indexOf('Android') > 0 && navigator.userAgent.indexOf('Mobile') > 0 || navigator.userAgent.indexOf('Android') > 0) {
	$(window).on('load',function(){
		window.setTimeout(() => {
			var window_h = screen.height;
			var magazine_h = $('.magazine img').height();
			var mTop = (window_h - magazine_h) / 2;
			$('.magazine').css('margin-top', mTop + 'px');
		}, 200);
	});
}
</script>
