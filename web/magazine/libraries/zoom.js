...
zoomMethods = {
  ...
  zoomIn: function(event) {
    ...
    console.log('pos:' + pos.x + '  Y:' + pos.y);
// console.log('page X:' + event.pageX + '  Y:' + event.pageY);
// console.log('flip X:' + flipPos.x + '  Y:' + flipPos.y);
// console.log('thisOffset X:' + thisOffset.left + '  Y:' + thisOffset.top);
// console.log('event X:' + event.target.offsetWidth + '  Y:' + event.target.offsetHeight);
    ...
    realPos = point2D(
      ...
      //   zoom_r * event.pageX,
      //   zoom_r * event.pageY
      //   0 - center.x - flipPos.x - move.x,
      //   0 - center.y - flipPos.y - move.y
    );
    console.log(center);
    console.log(realPos);
    var css = {};
